...
public slots:
	...
	void requestSetLocalUserComment_v_1_0_x(mumble_plugin_id_t callerID, mumble_connection_t connection,
											const char *comment, std::shared_ptr< api_promise_t > promise);
	void requestStartLocalUserWhisperShout_v_1_3_x(mumble_plugin_id_t callerID, mumble_connection_t connection,
												   const mumble_userid_t *users, const size_t userCount,
												   const mumble_channelid_t *channels, const size_t channelCount,
												   uint32_t *allocID, std::shared_ptr< api_promise_t > promise);
	void requestStopLocalUserWhisperShout_v_1_3_x(mumble_plugin_id_t callerID, mumble_connection_t connection,
												  const uint32_t allocID, std::shared_ptr< api_promise_t > promise);
