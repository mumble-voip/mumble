...
/**
 * @return true if the user himself is in or below the given channel.
 */
...
/**
 * @returns true if the given channel ought to be filtered from the UI
 */
static bool isChannelFiltered(const Channel *c) {
