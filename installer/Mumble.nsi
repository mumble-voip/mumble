...
Section "Mumble & Murmur" SecMumble
 ...
 NoDBusRunning:
  ...
  SetOverwrite on
  File "qos.reg"
  File "\dev\Qt4.3.4\lib\QtCore4.dll"
  File "\dev\Qt4.3.4\lib\QtGui4.dll"
  File "\dev\Qt4.3.4\lib\QtNetwork4.dll"
  File "\dev\Qt4.3.4\lib\QtSql4.dll"
  File "\dev\Qt4.3.4\lib\QtOpenGL4.dll"
  File "\dev\Qt4.3.4\lib\QtXml4.dll"
  File "\dev\Qt4.3.4\lib\QtDBus4.dll"
