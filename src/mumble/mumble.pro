...
DIST		+= licenses.h mumble.ico mumble.xpm firmumble.inc plugins/mumble_plugin.h mumble-overlay mumble.desktop murmur_pch.h
...
unix {
  ...
  macx {
    ...
    #SOURCES += GlobalShortcut_macx.cpp Overlay_macx.cpp
  }
