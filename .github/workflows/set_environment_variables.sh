...
case "$os" in
	"ubuntu")
		...
		MUMBLE_ENVIRONMENT_VERSION="mumble_env.${VCPKG_TARGET_TRIPLET}.2025-02-27.d7001f6639"
		;;
	"windows")
		VCPKG_TARGET_TRIPLET="$VCPKG_TARGET_TRIPLET-windows-static-md"
		MUMBLE_ENVIRONMENT_VERSION="mumble_env.${VCPKG_TARGET_TRIPLET}.2025-02-27.fa0adb3ba5"
		;;
	"macos")
