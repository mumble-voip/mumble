...
#undef PROCESS_MUMBLE_TCP_MESSAGE
	...
	void requestUserStats(unsigned int uiSession, bool statsOnly, const QStringList &temporaryAccessTokens = {});
	void joinChannel(unsigned int uiSession, unsigned int channel, const QStringList &temporaryAccessTokens = {});
	void startListeningToChannel(unsigned int channel, const QStringList &temporaryAccessTokens = {});
	void startListeningToChannels(const QList< unsigned int > &channelIDs,
								  const QStringList &temporaryAccessTokens = {});
	void stopListeningToChannel(unsigned int channel, const QStringList &temporaryAccessTokens = {});
	...
	void createChannel(unsigned int parent_id, const QString &name, const QString &description, unsigned int position,
					   bool temporary, unsigned int maxUsers, const QStringList &temporaryAccessTokens = {});
	void requestBanList(const QStringList &temporaryAccessTokens = {});
	void requestUserList(const QStringList &temporaryAccessTokens = {});
	void requestACL(unsigned int channel, const QStringList &temporaryAccessTokens = {});
	void registerUser(unsigned int uiSession, const QStringList &temporaryAccessTokens = {});
	...
	void sendChannelTextMessage(unsigned int channel, const QString &message_, bool tree,
								const QStringList &temporaryAccessTokens = {});
	void setUserComment(unsigned int uiSession, const QString &comment, const QStringList &temporaryAccessTokens = {});
	void setUserTexture(unsigned int uiSession, const QByteArray &qba, const QStringList &temporaryAccessTokens = {});
	void setTokens(const QStringList &tokens);
	void removeChannel(unsigned int channel, const QStringList &temporaryAccessTokens = {});
	void addChannelLink(unsigned int channel, unsigned int link, const QStringList &temporaryAccessTokens = {});
	void addChannelLinks(const unsigned int channelCount, const unsigned int *channelSet,
						 const QStringList &temporaryAccessTokens = {});
	void removeChannelLink(unsigned int channel, unsigned int link, const QStringList &temporaryAccessTokens = {});
	void removeChannelLinks(const unsigned int channel, const unsigned int channelCount, const unsigned int *channelSet,
							const QStringList &temporaryAccessTokens = {});
