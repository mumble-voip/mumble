...
LangString MUMBLE_TERMINATE_DBUS ${LANG_FRENCH} "Le Demon DBus utilisé par Mumble est en cours d'utilisation. Terminer le processus demon pour procéder à la mise à jour?"
...
; Already installed
LangString MUMBLE_ALREADY_INSTALLED ${LANG_FRENCH} "Mumble est déjà installé. Il est recommandé de désinstallé l'ancienne version avant de procéder à cette installation. Choisisser une option et cliquer sur Suivant pour continuer."
LangString MUMBLE_ALREADY_INSTALLED_HEAD ${LANG_FRENCH} "Déjà installé"
LangString MUMBLE_ALREADY_INSTALLED_SUBTEXT ${LANG_FRENCH} "Choisisser comment installer Mumble."
LangString MUMBLE_UNINSTALL ${LANG_FRENCH} "Désinstaller avant d'installer"
