...
static void about(HWND h) {
	::MessageBox(h, L"Reads audio position information from Team Fortress 2 (Build 3897)", L"Mumble TF2 Plugin", MB_OK);
}
...
static int trylock() {
	...
	/*
		position tuple:		client.dll+0x4aa6a0  (x,y,z, float)
		orientation tuple:	client.dll+0x4aa614  (v,h float)
...
static std::wstring description(L"Team Fortress 2 (Build 3897)");
